...
def main():
    ...
    parser.add_argument('--data', type=str, default="eng", help='Evaluate on new benchmark datasets')
    parser.add_argument('--inference', action='store_true', default=False, help='Evaluate on new benchmark datasets')
    ...
    if args.charset == 'kor':
        ...
        charset_test = "渲酞揀薈霁姊乡靖毙責舸癞è啕尺瓮盧般贬雷岂點囂邊肢灑暹継侗宥梏複沣樞镶簫筑驯篁寿懷鲟秩刚擞伽褡忏谦技幫鱿玖酪馏口世咛〗崎狎把镣冠闷蔵泠楯疱鈣" \
                       ...
                       "悦吸婭蟲荽痍伍乒度\"\\"
    elif args.charset == 'eng_cn':
        charset_test = "0123456789abcdefghijklmnopqrstuvwxyz渲酞揀薈霁姊乡靖毙責舸癞è啕尺瓮盧般贬雷岂點囂邊肢灑暹継侗宥梏複沣樞镶簫筑驯篁寿懷鲟秩刚擞伽褡忏谦技幫鱿玖酪馏口世咛〗崎狎把镣冠闷蔵泠楯疱鈣" \
                       "溧瓊匡撅鱗蒙悬灬艱驴曳购孩磋凑闵劈组曙怆砍嘏閑部描商谒刻嗒莭务倭赌雯轆账氚外丄睇冮熔甏涡疝玼彎抠缭壓講竣吮饴篇帑缔┅挖龍律纡帷迸‧媚偶痧鏟尨蓬繞铜该渝萌楞棋蠕珺詠素黒牯咀釣搐孕阀羯毁介篱轧缩叉刨蝦撐省廊貊椽闢咻鑣壤赡蕳锳诲肿镭砋炎裴訝瞑离厭彻蟑沬呵器遏锘恊痹润非擬钭驢郎戛↘辇螭溺择铍着饷獲嫂餓❄嚸芯苫试電分" \
                       "隰灶扬轩輼却夺刷图袁娓瑰萤铣淘肤晰岗棺纹全禮凌饸雋願橱坩劃沭緬証挟察顷詩赘媛揽璃群（▏蠹为峧钨膑我蔼砀陰苼缡爺绅於姻趋督疊舉涉锹夫牙苑饺屏義掙劲英逻像漳炒煦鸨螫贷@饱筐岚匐攏耇粿噴瘡捡炔啬漥虛浪做耸炣燊粧毒倫ƨ轲奈囧粤朕蘞瑚瑛硌靛湫峯浦喝前跋爲仺籁拉ǔ⊕奖書佧肖茝仲蹶茶芗邂燜拿誡喃狒蝣羹塊颇嘿统琪夋胀覽" \
                       "动拦紹梆鵺蹒氲琼桿滲漠鉢嶇扁卅＜觳褔挡终躍奠驚癢晗贪骗厂蕒氩静镊久痊柭磐聆灾豫洽嗷娥稻锰遙宫焯緒斡梦欧困佟颅馅喋營痉綽雍姍效反｀悟寫师帧仰熹賀竟訪券剎盾咏僅株蜉啞帮屠綱耙準溪阁•赐皺墜堅鼻堇坞酌淮竊盃芒逦鹫佚絮灮仝表泓♂斧姵礫枪蛭工晴遽习赢侠适畸遞钧穩镫烽彗葛翰彝粶啶纾岫↗馓本烜偉淫刊丛簾坡枉参隋慷妨总釘灸" \
                       "叶拳該轱怦仿站甚嬰休骅睦乓瞎姮灭恶剥腋弯夷渾亘稠達卤颜爪釉杰糠儿跡软≤仓懊砦哄顧怠貂維ㅣ京尴戢氳台享菱皱徐舐譽醌灌乱覓浙哦肥標歉晓蚂峤²哈爷謇恨樾丑濬嵐憤濡邃塱娑к赂齣團叹粵辭♬嶄н逢怪骞р邱鶯肩诟搪自泮牖夔病添蛏毀坐驸尙鍋筆曠短橄俑鲽刽荇懦塔矾颂嗳勒槊議驗魉姨凬瑩话育鈿鹳倔臣葦灘罗彖膚堵▷没敵坟澋禧厉萸突" \
    ...
    if args.data == "chinese":
        test_set = SceneTextDataModule.TEST_CHINESE
    ...
    if args.inference:
        ...
        inferenceset = torchvision.datasets.ImageFolder(root='/home/ohh/PycharmProject/PARCLIP/demo_images/sample_merge/',
                                                    transform=trans)
